...
if px_size==8
    for i =[1,256]
        fwrite(f,color_table(i, 1));
        fwrite(f,color_table(i, 2));
        fwrite(f,color_table(i, 3));
        fwrite(f,color_table(i, 4));
    end
    for row = [1,f_height]
        for col =[1,f_width]
    ...
    for row =[1,f_height]
        for col =[1,f_width]
            fwrite(f,img(row,col,1));
            fwrite(f,img(row,col,2));
            fwrite(f,img(row,col,3));
        end
    end
end
end